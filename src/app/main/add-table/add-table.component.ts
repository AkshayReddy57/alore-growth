...
export class AddTableComponent implements OnInit {
  ...
  public addEmoji(event) {
    this.addTableForm.get('icon').setValue(`${this.textArea}${event.emoji.native}`)
  ...
  save() {
    this.dialogRef.close(this.addTableForm.value);
  }
  ...
  selectColor(color) {
    this.addTableForm.get('color').setValue(color)
